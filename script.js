...
function loadProjects() {
  for (let certificationIndex = 0; certificationIndex < CERTIFICATIONS.length; certificationIndex++) {
    ...
    for (let i = 0; i < currentProjects.length; i++) {
      ...
      const projectHtml = "<div class='project-card'><h3 class='project-name'>" + name + "</h3><div class='project-btns'><a class='btn' href='" + link + "'><p><i class='fas fa-desktop'></i> View</p></a><a class='btn' href='" + sourcecode + "' target='_blank'><p><i class='fas fa-code'></i> Source</p></a></div></div>";
